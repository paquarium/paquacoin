...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s paquacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  paquacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded paquacoin transaction") + "\n" +
              "  paquacoin-tx [options] -create [commands]   " + _("Create hex-encoded paquacoin transaction") + "\n" +
              "\n";
