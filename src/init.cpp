...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/paquacoin-project/paquacoin>";
    const std::string URL_WEBSITE = "<https://paquacoin.org>";
